  ...
  return (
    <aside className={`fixed top-[60px] right-0 bottom-0 w-96 flex flex-col bg-white dark:bg-[#1e293b] border-l border-gray-200 dark:border-gray-800 shadow-2xl z-40 transition-transform duration-300 ${employee ? 'translate-x-0' : 'translate-x-full'}`}>
      <div className="flex items-center justify-between px-6 pt-6 pb-2">
        <h2 className="text-[#111418] dark:text-white text-xl font-bold leading-tight">Edit Employee</h2>
      ...
      <div className="p-6 flex flex-col gap-6 overflow-y-auto flex-1">
        ...
        <div className="flex flex-col gap-4">
          <div className="flex flex-col gap-1.5">
            ...
            <input
              className="w-full h-10 rounded-lg border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white px-3 focus:ring-2 focus:ring-primary focus:border-transparent transition-all outline-none"
              value={formData.name}
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <textarea
              className="w-full rounded-lg border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white p-3 h-24 resize-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all outline-none text-sm"
